export const skillsData = {
    frontend: ["Quasar", "Vue.js", "React (básico)", "HTML", "CSS", "Bootstrap"],
    backend: ["Starlette", "FastAPI", "Node.js"],
    languages: ["Python", "TypeScript", "JavaScript", "C# (básico)", "Java (básico)", "Transact-SQL (básico)", "Rust (básico)", "MASM Assembly (básico)"],
